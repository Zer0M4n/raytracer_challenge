...
It is based on the book "The Ray Tracer Challenge" by Jamis Buck and other sources. For more information about how it was built, see [LEARN.es.md](LEARN.es.md).
